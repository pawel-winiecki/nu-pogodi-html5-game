...
GameSpace.Controls = function(game) {
    this.game = game;
...
GameSpace.Controls.prototype = {
    prepareMenuControls: function() {
        ...
        buttons.push(this.game.add.button(this.game.world.centerX - (60 * scale * 2),
                this.game.world.centerY - (23 * scale * 2),
                'start',
                this.beginGame, this));
        buttons.push(this.game.add.button(30 * scale * 2, 226 * scale * 2+20, 'button-left-down', this.beginGame, this));
        buttons.push(this.game.add.button(30 * scale * 2, 170 * scale * 2+20, 'button-left-up', this.beginGame, this));
        buttons.push(this.game.add.button(393 * scale * 2, 226 * scale * 2+20, 'button-right-down', this.beginGame, this));
        buttons.push(this.game.add.button(393 * scale * 2, 170 * scale * 2+20, 'button-right-up', this.beginGame, this));
    ...
    prepareGameControls: function(wolf) {
        ...
        buttons.push(this.game.add.button(30 * scale * 2, 226 * scale * 2+20, 'button-left-down', this.actionButtonLeftDown, this));
        buttons.push(this.game.add.button(30 * scale * 2, 170 * scale * 2+20, 'button-left-up', this.actionButtonLeftUp, this));
        buttons.push(this.game.add.button(393 * scale * 2, 226 * scale * 2+20, 'button-right-down', this.actionButtonRightDown, this));
        buttons.push(this.game.add.button(393 * scale * 2, 170 * scale * 2+20, 'button-right-up', this.actionButtonRightUp, this));
